...
const PrivateServicesTemplate = ({ data }) => {
  ...
  return (
    <Page>
      ...
      <PageHeader img={headerImage} title="Palvelut yrityksille" />
      ...
      <Section>
        ...
        <p>
          ...
          sekä asiakkaat että työntekijät viihtyvät. Toimivat ja viihtyisät
          tilat lisäävät yrityksen houkuttelevuutta ja näin ollen tukevat
        ...
        <p>
          ...
          tilan käyttäjien tarpeet ja toiveet. Konseptisuunnittelun tavoitteena
          on luoda juuri sopivat, brändin mukaiset tilat omalle asiakaskunnalle
          ja henkilöstölle.
        </p>
