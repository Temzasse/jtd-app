...
const PublicServicesTemplate = ({ data }) => {
  ...
  return (
    <Page>
      ...
      <PageHeader img={headerImage} title="Palvelut yksityisille" />
      ...
      <Section>
        ...
        <p>
          ...
          uudiskohteisiin ja vapaa-ajan asuntoihin asiakkaan toiveet huomioiden.
          Kotien suunnittelussa on tärkeintä, että lopputuloksena on
          persoonallinen, juuri sinulle suunniteltu koti.
        </p>
      ...
      <InfoSection bg={theme.primary[200]} h="auto">
        ...
        <Text as="p">
          Pintamateriaaleista, väreistä, irtokalusteista ja tekstiileistä
          tehdään huonekortit, joissa on tietoa myös ko. tuotteiden
          hankintapaikoista. Sisustussuunnitelman laajuus sovitaan etukäteen
          aina asiakkaan tarpeen ja toiveiden mukaan. Sopimukseen voidaan
          sisällyttää kaikki edellä mainitut osakokonaisuudet tai vain osa
          niistä. Sopimukseen voidaan sisällyttää tarvittaessa myös
          tarjouspyynnöt, tilaukset ja jopa tavaroiden paikalleen asettaminen.
        </Text>
